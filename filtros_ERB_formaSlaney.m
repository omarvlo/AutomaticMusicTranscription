function [s_filtrada, resp_final] =filtros_ERB(fs,num_filtros,frec_minima,espectrograma,corte,valor_corte)
...
for i=1:1:segmento
    for j=1:1:num_filtros-1
        ...
        almacenado = filtros_ERB(:,i) + almacenado;
    end
end

s_filtrada = almacenado;
